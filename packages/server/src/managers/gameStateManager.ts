...
const VALID_TRANSITIONS: Record<GamePhase, GamePhase[]> = {
  lobby:            ['board'],
  board:            ['question', 'all_play', 'double_wager', 'speed_round', 'final_challenge', 'game_over'],
  question:         ['buzzer_queue', 'answer_reveal', 'board'],
  buzzer_queue:     ['buzzer_queue', 'answer_reveal', 'board', 'all_play'],
  all_play:         ['buzzer_queue', 'all_play', 'answer_reveal', 'board'],
  double_wager:     ['question'],
  answer_reveal:    ['board', 'final_challenge'],
  final_challenge:  ['final_answer', 'final_reveal'],
  final_answer:     ['final_reveal'],
  final_reveal:     ['game_over'],
  game_over:        [],
  speed_round:      ['answer_reveal', 'board'],
};

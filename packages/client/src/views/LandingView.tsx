  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 gap-8">
      <div className="text-center">
        ...
        <p className="text-blue-200 text-lg">O quiz show mais divertido com seus amigos</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-6 w-full max-w-2xl">
        ...
        <div className="card flex-1 flex flex-col gap-4">
          ...
          <p className="text-blue-200 text-sm">Crie uma sala e convide seus amigos</p>
          <button
        ...
        <div className="card flex-1 flex flex-col gap-4">
          ...
          <form onSubmit={handleJoin} className="flex flex-col gap-3">
            <input
              ...
              maxLength={30}
              className="bg-jeopardy-blue border-2 border-blue-400 rounded-lg px-4 py-3 text-white placeholder-blue-400 focus:outline-none focus:border-jeopardy-gold"
            />
            <input
              type="text"
              ...
              maxLength={6}
              className="bg-jeopardy-blue border-2 border-blue-400 rounded-lg px-4 py-3 text-white placeholder-blue-400 uppercase tracking-widest text-center text-xl focus:outline-none focus:border-jeopardy-gold"
            />
